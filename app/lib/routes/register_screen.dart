        ...
        error: (error, _) {
          ...
          if (error is DioException) {
            try {
              ...
              if (apiError.detail?.data?.email?.code == 'validation_not_unique') {
                displayMessage = l10n.email_not_unique;
              } else if (apiError.detail?.data?.username?.code == 'validation_not_unique') {
                displayMessage = l10n.username_not_unique;
              } else {
                    ...
                    child: AutofillGroup(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            'Utwórz konto Live Ride i zacznij jeździć.',
                            style: TextStyle(
                          ...
                          Text(
                            'Twoje trasy. Twoje dane. Twój Live Ride.',
