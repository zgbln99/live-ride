...
const UserCreateSchema = (z.object({
    ...
    // Nazwa wyświetlana: to ona trafia obok pozycji na publicznej stronie
    // LIVE. Nieobowiązkowa, bo starsze konta jej nie mają i formularze
    // webowe jej nie zbierają — wtedy zostaje nazwa użytkownika.
